...
<!-- Placeholders: 36-red-teaming = project folder name | 2026-03-15 = YYYY-MM-DD format | agent:copilot = agent:name or human:name -->

# 36-red-teaming - Organization Standards
